    ...
    public class MessageSet : ICloneable
    {
        ...
        public string Yes
        {
            get
            {
                ...
                Message message = (from m in this.Messages
                                   where String.Compare(m.Id, "yesstr", CultureInfo.InvariantCulture, CompareOptions.None) == 0
        ...
        public string No
        {
            get
            {
                ...
                Message message = (from m in this.Messages
                                   where String.Compare(m.Id, "nostr", CultureInfo.InvariantCulture, CompareOptions.None) == 0
                                   select m).FirstOrDefault();
