namespace NCldr.Types
{
    ...
    public class PluralRule
    {
        ...
        public bool IsMatch(int value)
        {
            ...
            return string.Compare(booleanRule, TrueString, CultureInfo.InvariantCulture, CompareOptions.None) == 0;
        }
        ...
        private string NisEvaluator(Match match)
        {
            ...
            if (string.Compare(matchLeftHandSide, "n", CultureInfo.InvariantCulture, CompareOptions.None) == 0)
            {
